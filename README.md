...
- [reliopt](https://github.com/obielin/reliopt) - Reliability-constrained, multi-objective optimization for LLM/agent programs — contract-gated Pareto frontiers instead of a single blended score.
